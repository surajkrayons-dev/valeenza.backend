! function (a) {
    ...
    a("#side-menu").metisMenu(), a("#vertical-menu-btn").on("click", function (e) {
        ...
        function () {
            ...
            r(e.target.id)
        }), a("#password-addon,.password-addon").on("click", function () {
