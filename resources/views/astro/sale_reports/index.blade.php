        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                <div class="page-title-right">
                    <a href="{{ route('client.sale_reports.export.xlsx.data') }}"
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            <div class="form-group">
                                <label for="store_id" class="form-label fw-bold">Store :</label>
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select name="product_id" id="product_id" class="form-control select2-class2"
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#data-table').DataTable({
                ajax: {
                    url: '{{ route('client.sale_reports.list') }}',
                    data: function(d) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        mRender: (data, type, row) => {
                            return `
                                <a href="javascript:void(0);" data-href="{{ route('client.sale_reports.view') }}/${row.id}" class="btn btn-soft-success btn-sm waves-effect waves-light open-remote-modal" data-target="#lgRemoteModal"><i class="mdi mdi-eye font-size-16"></i></a>
                            `;
                        },
                        orderable: false,
                        searchable: false
            ...
            $('#store_id, #promoter_id, #product_id').on('input change', function() {
                reloadTable('#data-table');
            });
