...
@section('title') Pincodes @endsection
            ...
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                ...
                @if (Can::is_accessible('pin_codes', 'create'))
                    <div class="page-title-right">
                        <a href="javascript:void(0);" data-href="{{ route('admin.pin_codes.create.index') }}" class="btn btn-soft-info waves-effect waves-light open-remote-modal"><i class="fas fa-plus"></i> Create</a>
                        {{-- <a href="javascript:void(0);" data-href="{{ route('admin.pin_codes.import.csv.index') }}" class="btn btn-success waves-effect waves-light open-remote-modal"><i class="fas fa-file"></i> Import</a> --}}
                        <a href="javascript:void(0);" data-href="{{ route('admin.pin_codes.import.xlsx.index') }}" class="btn btn-soft-success waves-effect waves-light open-remote-modal" title="Import"><i class="fas fa-file"></i> Import </a>
                        <a href="{{ route('admin.pin_codes.export.xlsx.data') }}" class="btn btn-soft-warning waves-effect waves-light" title="Export"><i class="fas fa-file"></i> Export</a>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $('#data-table').DataTable({
                ajax: '{{ route("admin.pin_codes.list") }}',
                @if (Can::is_accessible('pin_codes', 'create'))
                    dom: DT_DOM_OPTION,
                ...
                columns : [
                    ...
                    { data: 'city', name: 'cities.name' },
                    {
                        ...
                        mRender: (data, type, row) => {
                            return `
                                @if (Can::is_accessible('pin_codes', 'update'))
                    ...
                    },
                    {
                        ...
                        mRender: (data, type, row) => {
                            return `
                                ...
                                @endif
                                @if (Can::is_accessible('pin_codes', 'delete'))
