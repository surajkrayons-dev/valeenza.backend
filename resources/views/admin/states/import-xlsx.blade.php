<div id="import-wrapper">
    <div class="modal-header">
        <h5 class="modal-title">Import States xlsx</h5>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        <label for="name" class="form-label">Choose xlsx File <a href="{{ route('admin.states.import.xlsx.download.sample') }}" class="btn btn-sm btn-link">(Download Xlsx)</a></label>
                        <div>
...
<script>
    $('#import-wrapper').on('click', '#importBtn', function (e) {
        ...
        $.ajax({
            dataType: 'json',
            type: 'POST',
            url: "{{ route('admin.states.import.xlsx.data') }}",
