            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="form-group">
                        ...
                        <input type="text" name="country_name" id="name" class="form-control" placeholder="Enter Country Name"/>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="form-group">
...
<script>
    $('#create-country-wrapper').on('click', '#createBtn', function (e) {
        e.preventDefault();
        const $btn = $(this);
        ...
        $.ajax({
            ...
            success: response => {
                ...
                $('#create-country-wrapper .close').click();
            }
        });
    });
</script>