    ...
    <div class="row">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-3">
                            ...
                            <textarea name="description" id="description" class="form-control" placeholder="Enter blog description...">{!! $blog->description !!}</textarea>
                        </div>
        ...
        <div class="col-lg-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="form-group">
                        <input type="file" name="image" class="dropify" data-default-file="{{ $blog->image ? asset('storage/blog/'.$blog->image) : '' }}" />
                        <small class="text-muted">
                            <b>Recommended:</b> 250x250 px
                        </small>
                    </div>
                </div>
            </div>
            ...
            <div class="card mt-3">
                <div class="card-body">
                    <button id="updateBtn" type="submit" class="btn btn-success w-100 mb-2">
                        Update Blog
                    </button>
