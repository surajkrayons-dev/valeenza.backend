                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8 mb-3">
                                        ...
                                        <input type="text" name="state_name" class="form-control"
                                            placeholder="Enter state name" maxlength="100" required>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <input type="text" name="state_code" id="state_code"
                                            class="form-control text-uppercase" placeholder="e.g. CA" maxlength="2"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="state_rate" id="state_rate" class="form-control"
                                            min="0" max="100" step="0.01" placeholder="Enter state rate"
                                            required>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input type="number" name="local_rate" id="local_rate" class="form-control"
                                            min="0" max="100" step="0.01" placeholder="Enter local rate"
                                            required>
    ...
    <script>
        $(document).ready(function() {
            ...
            function calculateCombinedRate() {
                ...
                let stateRate = parseFloat($('#state_rate').val()) || 0;

                let localRate = parseFloat($('#local_rate').val()) || 0;

                let combinedRate = stateRate + localRate;
            ...
            $('#createBtn').click(function(e) {
                ...
                // Make sure combined rate is latest
                calculateCombinedRate();
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.product_taxes.create') }}",
