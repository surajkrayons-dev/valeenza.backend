        ...
        <div id="sidebar-menu">
            <ul class="metismenu list-unstyled" id="side-menu">
                ...
                @if ($user && $user->isSuperAdmin())
                    ...
                    <li class="menu-title">Delivery Rates & Product Taxes</li>
                    ...
                    <li>
                        <a href="{{ route('admin.product_taxes.index') }}">
                ...
                @elseif($user)
                    ...
                    @if ($user->hasAccess('delivery_rates') || $user->hasAccess('product_taxes'))
                        <li class="menu-title">Delivery Rates & Product Taxes</li>
                    @endif
                    ...
                    @if ($user->hasAccess('product_taxes'))
                        <li>
                            <a href="{{ route('admin.product_taxes.index') }}">
                                <i class="bx bx-calculator"></i>
                                <span>Product Taxes</span>
                    ...
                    {{-- PRODUCTS --}}
                    @if ($user->hasAccess('coupons') || $user->hasAccess('product_categories') || $user->hasAccess('products'))
                        <li class="menu-title">Coupons & Products</li>
                    @endif
                    ...
                    {{-- BANNERS --}}
                    @if ($user->hasAccess('astro_banners') || $user->hasAccess('store_banners') || $user->hasAccess('send_mail'))
                        <li class="menu-title">Banners</li>
                    @endif
